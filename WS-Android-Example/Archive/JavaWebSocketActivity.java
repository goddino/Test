...
public class JavaWebSocketActivity extends Activity {
  ...
  // private WebSocketImpl wsClient;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    try {
      ...
      // wsClient = new WsClient( new URI( "ws://49.128.39.190:8887" ), new Draft_10() );
      // wsClient = new WsClient( new URI( "ws://49.128.39.190:8887" ) );
      // wsClient = new WebSocketClient( new URI( "ws://49.128.39.190:8887" ), new Draft_17() );
      // wsClient = new WsClient( new URI( "http://49.128.39.190:8887" ), new Draft_17() );
